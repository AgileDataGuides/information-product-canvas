<script lang="ts">
	...
	import { CONTEXT_TYPES } from '$lib/constants/context-types';
	...
	const entityType = $derived(CONTEXT_TYPES[node.label]);
...
<div
	...
	style="border-color: {entityType?.color || '#6b7280'}30; background-color: {entityType?.color || '#6b7280'}08;"
	role="button"
	tabindex="0"
...
>
	<div class="flex items-start gap-1.5">
		<span
			...
			style="background-color: {entityType?.color || '#6b7280'}"
		></span>
